...
public class acmilanhome extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.acmilan_home); // Pastikan nama layout sesuai dengan file XML Anda
        ...
        myButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(acmilanhome.this, acmilanhome_co.class); // Ganti dengan activity tujuan
        ...
        myImageView2.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Toast.makeText(acmilanhome.this, "Additional Image 1 Clicked", Toast.LENGTH_SHORT).show();
            }
        });
        ...
        myImageView3.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Toast.makeText(acmilanhome.this, "Additional Image 2 Clicked", Toast.LENGTH_SHORT).show();
            }
        });
        ...
        myImageView4.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Toast.makeText(acmilanhome.this, "Additional Image 3 Clicked", Toast.LENGTH_SHORT).show();
            }
        });
        ...
        myImageView5.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Toast.makeText(acmilanhome.this, "Additional Image 4 Clicked", Toast.LENGTH_SHORT).show();
            }
        });
    }
}
