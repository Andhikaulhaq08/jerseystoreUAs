...
public class check_out extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        myImageView2.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Toast.makeText(check_out.this, "Additional Image 1 Clicked", Toast.LENGTH_SHORT).show();
            }
        });
        ...
        myImageView3.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Toast.makeText(check_out.this, "Additional Image 2 Clicked", Toast.LENGTH_SHORT).show();
            }
        });
        ...
        myImageView4.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Toast.makeText(check_out.this, "Additional Image 3 Clicked", Toast.LENGTH_SHORT).show();
            }
        });
        ...
        myImageView5.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Toast.makeText(check_out.this, "Additional Image 4 Clicked", Toast.LENGTH_SHORT).show();
            }
        });
    }
}
